...
Код программы для первого случая $\frac{dn}{dt} = (0.805 + 0.000023n(t))(N-n(t))$:
...
Код программы для второго случая $\frac{dn}{dt} = (0.000085 + 0.63n(t))(N-n(t))$:
...
Код программы для третьего случая $\frac{dn}{dt} = (0.8t+0.3*t*n(t))(N-n(t))$:
