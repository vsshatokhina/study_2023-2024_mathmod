...
## Задание лабораторной работы. Вариант 57
...
!["Полученный график Julia. Первый случай"](image/1.png){#fig:002}

## Результаты работы кода на Julia

На рис. @fig:002 и @fig:003 изображены итоговые графики для обоих случаев.

!["Полученный график Julia. Второй случай"](image/2.png){#fig:003}
...
!["Полученный график OpenModelica. Первый случай"](image/3.jpg){#fig:006}

## Результаты работы кода на OpenModelica

На графиках на рис. @fig:006 и @fig:007, построенных с помощью OpenModelica изображены графики, аналогичные графикам @fig:002 и @fig:003 соответственно.

!["Полученный график OpenModelica. Второй случай"](image/4.jpg){#fig:007}
