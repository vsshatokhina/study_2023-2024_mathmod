...
subtitle: "Задача об эпидемии. Вариант №57"
...
$(N=12159)$ в момент начала эпидемии $(t=0)$ число заболевших людей 
(являющихся распространителями инфекции) $I(0)=169$, А число здоровых людей с иммунитетом 
...
N = 12159
I0 = 169 # заболевшие особи
R0 = 17 # особи с иммунитетом
