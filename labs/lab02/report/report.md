...
Задания лабораторной работы разделены по вариантам. Мой вариант 57 
...
и осью, проходящей через катер береговой охраны. Тогда начальные координаты катера (20,1; 0). Обозначим скорость лодки $v$.
...
!["Компляция программы lab02.jl"]{#fig:004}
